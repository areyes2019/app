			...
			<div class="row">
				<div class="col-md-8">
					<div class="quality">
						...
						<button class="btn btn-danger btn-lg">Saber mas</button>
					</div>
				</div>
				<div class="col-md-4">
		...
		<div class="row">
			...
			<div class="col-md-8">
				<div class="big-title">
					...
					<p>Sus aplicaciones son varias pero las más comunes son para marcar bolsas de tela (aunque también se podrían marcar bolsas de plástico con una tinta especial de secaje rápido) y para marcar cajas de diferentes tipos de negocio.</p>
					<a href="" class="btn my-btn-red">Me interesa</a>
				</div>
			</div>
		</div>
